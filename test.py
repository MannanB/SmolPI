...
def batch_test(baseline=False):
    cfg = Config(
        ...
        cam_sim_output_path=f"vids/front_cam_vla_batch_test_{baseline}.mp4",
        cam_omni_output_path=f"vids/omniscient_vla_batch_test_{baseline}.mp4",
        sim_duration_sec=5,
    )
    ...
    for objective in [MoveBackwardRewardModel, MoveToGreenPlatformRewardModel, FaceRedPlatformRewardModel, SpinClockwiseRewardModel]:
